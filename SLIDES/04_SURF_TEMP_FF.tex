...
\begin{itemize}
    ...
    \item<3-> Increasing the prescribed roughness height introduces a systematic increase in the mean surface temperature.
\end{itemize}
\end{block}
...
\only<1>{
\centering
\includegraphics[width=0.62\textwidth]{FIGURES/HTC/tc_oneram6_qc_prime_vs_n_y_0.75.png}
...
\begin{itemize}
    ...
    \item<1-> Most submissions show comparatively limited changes between L1 and L2, while deviations of approximately $25$--$50\%$ relative to L1 develop on the coarser grids for selected submissions.
