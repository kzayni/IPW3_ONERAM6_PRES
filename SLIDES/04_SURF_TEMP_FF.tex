...
\begin{itemize}
    ...
    \item <1-> Submission 001 exhibits a markedly different thermodynamic response, with substantially lower surface temperatures away from the leading edge.
...
\vspace{-0.2cm}
\centering
\includegraphics[width=0.78\textwidth]{FIGURES/SURF_TEMP_FF/tc_oneram6_mean_surface_temperature_vs_n_slice_1p4_grouped_roughness_participants.png}
...
\begin{itemize}
    ...
    \item<1-> Some submissions predict localized regions approaching complete freezing, while others predict predominantly low or zero freezing fractions.
...
\begin{itemize}
    ...
    \item<3-> Prescribed surface roughness introduces an additional systematic effect, but does not account for the large overall spread between submissions.
\end{itemize}
\end{block}
