...
\begin{itemize}
    ...
    \item Code-to-code differences in total water mass are larger than the grid-refinement effect for most submissions.
\end{itemize}
\end{block}
...
\begin{block}{\scriptsize Assessment}
\begin{itemize}
    \item The 15-, 7-, and 3-bin distributions produce very similar impinged water masses for most submissions.
...
\begin{column}{0.50\textwidth}
    ...
    {\scriptsize\textbf{Coefficient of Variation}}
\end{column}
...
\begin{itemize}
    ...
    \item Droplet-distribution resolution therefore has a substantially stronger influence on the \textbf{spatial extent} of impingement than on the integrated collected water mass.
\end{itemize}
\end{block}
